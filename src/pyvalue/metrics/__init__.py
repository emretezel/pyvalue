...
REGISTRY = {
    ...
    ROICMedianAdaptiveMetric.id: ROICMedianAdaptiveMetric,
    ...
    OperatingMarginTTMMetric.id: OperatingMarginTTMMetric,
    FCFMarginTTMMetric.id: FCFMarginTTMMetric,
    ROETTMMetric.id: ROETTMMetric,
    ROATTMMetric.id: ROATTMMetric,
    ROETangibleCommonEquityTTMMetric.id: ROETangibleCommonEquityTTMMetric,
    DividendYieldTTMMetric.id: DividendYieldTTMMetric,
    ShareholderYieldTTMMetric.id: ShareholderYieldTTMMetric,
    DividendPayoutRatioTTMMetric.id: DividendPayoutRatioTTMMetric,
    RevenueCAGR10YMetric.id: RevenueCAGR10YMetric,
