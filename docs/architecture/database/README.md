...
- The live database is on schema version `35`, but this migrated `data/pyvalue.db` has a verified `fundamentals_raw` preservation discrepancy: `75,848` current rows versus `77,045` in the pre-migration backup.
